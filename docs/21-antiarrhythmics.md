...
<!-- antiarrhythmics overall uses and SE -->
...
<!-- antiarrythmics overall moa, Na and K channel blockade result on QT, QRS, AP, ERP -->
...
<!-- 1a drug includes, effect on AP, uses, SE -->
...
<!-- class 1b drugs effect, include, moa, treats, SE -->
...
<!-- class 1c drugs moa, include, SE -->

![](https://photos.thisispiggy.com/file/wikiFiles/xgDS9GN.jpg)

- can go into cardiac arrest if QRS too long: limited use
...
<!-- use dependence moa, result, drugs -->
...
<!-- class III drugs effects, include -->
...
<!-- sotalol, dofetilide moa, uses, se -->
...
- Ca influx causes early after depolarizations, occur during phase 3 where cell depolarizes again and again
