...
<!-- most time spent in sleep is which stage.. -->

More time is spent in **N2 sleep** (45%) than any other stage.

<!-- teeth grinding sleep when.. -->

Bruxism (teeth-grinding) occurs in stage **N2 sleep**.

<!-- sleep walking, enuresis when.. -->

Sleepwalking and enuresis occur in **N3-4 sleep**.

## REM

<!-- REM sleep bod changes, time, eye movements driven by which part of brain.. -->
...
<!-- circadian rhythm sleep disorders subtypes and demographics.. -->
...
<!-- shiftwork circadian thythm disorder vs advanced or delayed sleep phase.. -->
...
- Example: A patient working a night shift has no sleep problems until she switches to a traditional 9-5 schedule. She has a history of difficulty waking up for early-morning classes when she was in college. _Diagnosis: Delayed sleep phase disorder._
...
<!-- narcolepsy treatment. Cataplexy treatment.. -->
...
<!-- kleine levin syndrome is, symptoms -->
...
<!-- REM sleep behavior disorder is, treatment --> 
